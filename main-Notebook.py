    ...
    if running:
        ...
        if pic_taken:
            ...
            if not len(values) == 0 and not len(values[0])  == 0:
                ...
                # wenn die erkennung wahrscheinlich richtig ist, dann weiter machen                                         150
                if certainty < 40 and not last_color == prediction and ((prediction == "white" and average_background[1] > 150) or (not prediction == "white" and average_background[1] > 100)):
